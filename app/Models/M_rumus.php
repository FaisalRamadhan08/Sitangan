...
class M_rumus extends Model
{
    ...
    protected $column_order = ['judul_rumus', 'rumus', 'created_at', 'updated_at'];
    protected $column_search = ['judul_rumus', 'rumus', 'created_at', 'updated_at'];
    protected $allowedFields = ['judul_rumus', 'rumus', 'created_at', 'updated_at'];
