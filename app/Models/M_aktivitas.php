...
class M_aktivitas extends Model
{
    ...
    protected $column_order = ['nama_user', 'email', 'deskripsi', 'aksi', 'created_at'];
    protected $column_search = ['nama_user', 'email', 'deskripsi', 'aksi', 'created_at'];
    protected $allowedFields = ['nama_user','email', 'deskripsi', 'aksi', 'created_at'];
