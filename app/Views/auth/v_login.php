                ...
                <div class="col-xl-7 p-0">
                    <div class="login-card">
                        ...
                        <form class="theme-form login-form" action="<?php echo base_url('/Master_login/login'); ?>" method="post" enctype="multipart/form-data">
                            <div class="p-b-10 justify-content-center text-center">
                    ...
                    <div class="modal fade" id="registrasiModal" tabindex="-1" role="dialog" aria-labelledby="registrasiModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="<?php echo base_url('/Master_login/regitrasi_users'); ?>" method="post" class="theme-form" enctype="multipart/form-data">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Regitrasi Users</h5>
                    ...
                    <div class="modal fade" id="forgetPasswordModal" tabindex="-1" role="dialog" aria-labelledby="forgetPasswordModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="<?php echo base_url('/Master_login/lupa_password'); ?>" method="post" class="theme-form" enctype="multipart/form-data">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="col-form-label">Email:</label>
                                            <input name="send_email" type="email" class="form-control" required>
                                        </div>
                                        <div class="modal-footer">
                                            <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Kembali</button>
