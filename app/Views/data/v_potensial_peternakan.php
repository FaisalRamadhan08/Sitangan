...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Potensial Pencemaran Peternakan</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Home</li>
                        <li class="breadcrumb-item active">Potensial Pencemaran Peternakan</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid dashboard-default-sec">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column flex-sm-row justify-content-between p-b-40">
                            <div class="d-flex">
                                ...
                                <a href="/Master_potensial_peternakan/eksport" type="button" class="btn btn-pill btn-secondary btn-air-secondary mx-1">
                        ...
                        <div class="table-responsive">
                            <table class="table m-b-10 table-stripedd text-center" id="table_potensial_peternakan">
                                <thead class="table-primary">
                                    <tr>
                                        <th>No.</th>
                                        <th>DAS</th>
                                        <th>Titik Pantau</th>
                                        <th>PBP Peternakan</th>
                                        <th>Detail</th>
                                        <th>Tanggal</th>
                                        <th>Aksi</th>
                                    </tr>
                ...
                <!-- MODAL ADD START -->
                <form action="<?php echo base_url('/Master_potensial_peternakan/add'); ?>" method="post" class="theme-form" enctype="multipart/form-data">
                        ...
                        <div class="modal-dialog modal-700" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Tambah Data Potensial Peternakan</h5>
                                ...
                                <div class="modal-body max-height-550">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="jumlah_ternak_add" name="jumlah_ternak" type="number" min="0" class="form-control" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">Jenis Ternak:</label>
                                        <select id="jenis_ternak_add" name="jenis_ternak" class="form-select">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="persentase_limbah_add" name="persentase_limbah" type="text" class="form-control" value="0.2" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label class="col-form-label">Faktor Pengali:</label>
                                        <input id="faktor_pengali_add" name="faktor_pengali" type="text" class="form-control" value="1000" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <button type="button" id="hitung-potensial-peternakan-button-add" class="btn btn-primary btn-air-primary w-100" onclick="hitungNilaiPBPPeternakan()" disabled>
                                            Hitung Potensial Peternakan
                                        </button>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">Nilai PBP Peternakan:</label>
                                        <input id="pbp_peternakan_add" name="pbp_peternakan" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                ...
                <!-- MODAL UPDATE START -->
                <form action="<?php echo base_url('/Master_potensial_peternakan/update'); ?>" method="post" class="theme-form" enctype="multipart/form-data">
                    <div class="modal fade" id="updatedModal" tabindex="-1" role="dialog" aria-labelledby="updatedModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
                        <div class="modal-dialog modal-700" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Ubah Data Potensial Peternakan</h5>
                                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body max-height-550">
                                    <input id="id_update_potensial_peternakan" name="id" type="hidden" class="form-control">
                                    <div class="mb-3">
                                        <label class="col-form-label">Das:</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="col-form-label">Jumlah Peternakan:</label>
                                        <input id="jumlah_ternak_update" name="jumlah_ternak" type="number" min="0" class="form-control" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">Jenis Ternak:</label>
                                        <select id="jenis_ternak_update" name="jenis_ternak" class="form-select">
                                            <option selected="" disabled="" value="">-- Pilih Jenis Perternakan --</option>
                                            <option value="sapi">Sapi</option>
                                            <option value="domba">Domba</option>
                                            <option value="ayam">Ayam</option>
                                    ...
                                    <div class="mb-3">
                                        <label class="col-form-label">Persentase Limbah:</label>
                                        <input id="persentase_limbah_update" name="persentase_limbah" type="text" class="form-control" value="0.2" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label class="col-form-label">Faktor Pengali:</label>
                                        <input id="faktor_pengali_update" name="faktor_pengali" type="text" class="form-control" value="1000" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <button type="button" id="hitung-potensial-peternakan-button-update" class="btn btn-primary btn-air-primary w-100" onclick="hitungNilaiPBPPeternakanUpdate()">
                                            Hitung Potensial Peternakan
                                        </button>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label">Nilai PBP Peternakan:</label>
                                        <input id="pbp_peternakan_update" name="pbp_peternakan" type="text" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Kembali</button>
                ...
                <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
                    <div class="modal-dialog modal-1200" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Detail Parameter Potensial Peternakan</h5>
                                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table m-b-10 table-stripedd text-center">
                                        <thead class="table-primary">
                                            <tr>
                                                <th>Jumlah Ternak</th>
                                                <th>Jenis Perternakan</th>
                                                <th>Nama Parameter</th>
                                                <th>Faktor Emisi Limbah Perternakan</th>
                                                <th>Persentase Limbah</th>
                                                <th>Faktor Pengali</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td id="jumlah_ternak_detail"></td>
                                                <td id="jenis_ternak_detail"></td>
                                                <td id="nama_parameter_detail"></td>
                                                <td id="faktor_emisi_detail"></td>
                                                <td id="persentase_limbah_detail"></td>
                ...
                <!-- MODAL IMPORT START -->
                <form action="<?php echo base_url('/Master_potensial_peternakan/import'); ?>" method="post" class="theme-form" enctype="multipart/form-data">
                    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Import Data Potensial Peternakan</h5>
                                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body max-height-550">
                                    <div class="mb-3 text-center">
                                        ...
                                        <a href="<?php echo base_url('/assets/template_excel/PotensialPeternakan.xlsx'); ?>" download="Template excel Potensial Peternakan" type="button" class="btn btn-primary btn-air-primary w-50">
                                            Download Template
                                        </a>
                                    </div>
...
<script type="text/javascript" src="<?php echo base_url('/assets/component/js/masterdata/potensial_peternakan.js'); ?>"></script>
<?= $this->endSection() ?>