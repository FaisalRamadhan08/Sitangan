...
$(document).ready(function () {
  ...
  $("#table_informasi_titik_pantau").DataTable();
  $("#table_status_mutu_air").DataTable();
  $("#table_index_kualitas_air").DataTable();
  $("#table_beban_pemcemaran_eksisting_bod").DataTable();
  $("#table_potensial_domestik").DataTable();
  $("#table_potensial_pertanian").DataTable();
  $("#table_potensial_peternakan").DataTable();
  $("#table_potensial_industri_1").DataTable();
  $("#table_potensial_industri_2").DataTable();
  $("#table_potensial_industri_3").DataTable();
});